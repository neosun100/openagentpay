"""HTTP client — same shape as openagentpay-strands.client."""
...
class OpenAgentPayClient:
    """Async HTTP client for the demo-api (lazy session lifecycle)."""
    ...
    async def pay(
        ...
        *,
        ...
        if mandates:
            body["mandates"] = mandates  # AP2 envelope flowing through
        ...
        if r.status_code == 404:
            self._session_state = None  # session was lost; force recreation next call
